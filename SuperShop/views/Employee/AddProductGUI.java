...
public class AddProductGUI extends JFrame implements ActionListener{
    ...
    public AddProductGUI() {
       ...
       // this.genaratedProductIdField.setText(generateNextProductId());
        ...
        this.vailableQuantityField.addActionListener(_ -> this.statusComboBox.requestFocusInWindow());
        ...
        this.unitComboBox = new JComboBox<String>(new String[]{"Kilogram","Piece", "Box", "Liter", "Meter"});
